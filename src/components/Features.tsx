      ...
      <div className="container mx-auto px-6">
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 sm:mt-20 lg:max-w-none lg:grid-cols-3">
          {features.map((feature, index) => (
            <div
              key={feature.name}
              className="flex flex-col rounded-2xl bg-[var(--neutral-white)] p-8 shadow-lg transition-transform hover:-translate-y-2"
            >
              <div 
                className="mb-4 flex h-12 w-12 items-center justify-center rounded-full text-[var(--neutral-white)]"
